...
class AdminSurveyTemplatesPage extends Component {
    ...
    onAddTemplateClicked = e => {
        window.location.href = "/admin/createsurveytemplate";
    }

    onEditTemplateClicked = e => {
        ...
        if (surveyTypeSelected === false) { //no survey type has been selected
            ...
            window.location.href = "/admin/surveytypeid=" + String(surveyTypeObjectToReturn.surveytypeid) + "/edittemplate";
        }

    }

    onDeleteTemplateClicked = e => {
        window.location.href = "/admin/deletetemplate";
    }
        ...
        return(
            <div>
                ...
                <header className = "Body">
                    <h1>Admin Survey Templates Page</h1>

                    <br></br>

                    <Button variant="contained"
                        onClick={this.onAddTemplateClicked}>
                    Create New Survey Template</Button>

                    <Button variant="contained"
                        onClick={this.onDeleteTemplateClicked}>
                    Delete Survey Templates</Button>
                                                ...
                                                <TableRow key={surveyType.type}>
                                                    ...
                                                    <TableCell>
                                                        <RadioGroup value={this.state.selectedValue} onChange={this.onSurveyTypeSelect}>
                                                            <Radio value={surveyType.type} control={<Radio />} label={surveyType.type} id={surveyType.type}/>
                                                        </RadioGroup>
                                                    </TableCell>
                                                </TableRow>
                                            )
                    ...
                    <br></br>
                    <p>To edit, please select a survey template and then click the edit button below:</p>

                    <Button variant="contained"
                        onClick={this.onEditTemplateClicked}>
                    Edit</Button>
                    
                    <h1 style={{ color: 'red' }}>{ this.state.showError ? "Please select a Survey Type to edit" : null }</h1>          
                </header>
